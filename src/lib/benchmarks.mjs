...
export const publishedBenchmarkRows = [
  ...
  },
  {
    ...
    status: "external reported",
    note: "Hindsight benchmark materials report LongMemEval and LoCoMo improvements for a structured memory architecture.",
    sourceLabel: "Hindsight benchmarks",
    sourceUrl: "https://github.com/vectorize-io/hindsight-benchmarks",
  },
  {
