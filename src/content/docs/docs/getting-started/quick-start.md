...
1. Click the deploy button:
   ...
   <a href="https://railway.com/deploy/automem-ai-memory-service?referralCode=VuFE6g" target="_blank" rel="noopener noreferrer" class="btn-lab-accent shadow-hard not-content" style="display: inline-flex; align-items: center; gap: 0.5rem; text-decoration: none; color: #1a1a1a;">
