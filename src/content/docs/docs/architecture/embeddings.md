...
:::note[Source files]
Key GitHub sources:
- [automem/embedding/runtime_pipeline.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/runtime_pipeline.py) — Embedding worker and batch processing logic
- [automem/embedding/runtime_bindings.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/runtime_bindings.py) — Queue setup and worker startup
- [automem/embedding/provider.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/provider.py) — Abstract provider base class
- [automem/embedding/voyage.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/voyage.py) — Voyage AI provider
- [automem/embedding/openai.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/openai.py) — OpenAI provider
- [automem/embedding/fastembed.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/fastembed.py) — FastEmbed local provider
- [automem/embedding/ollama.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/ollama.py) — Ollama local provider
- [automem/embedding/placeholder.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/embedding/placeholder.py) — Deterministic fallback provider
...
- [tests/test_embedding_providers.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/tests/test_embedding_providers.py) — Provider tests
:::
...
- **At write:** `validate_vector_dimensions()` in [automem/utils/validation.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/utils/validation.py) re-checks every embedding before `upsert`.
...
The `POST /memory` endpoint integrates with the embedding queue via [automem/api/memory.py](https://github.com/verygoodplugins/automem/blob/1b812cf883cbc95632d5f9f1ed180d1865c0638a/automem/api/memory.py).
